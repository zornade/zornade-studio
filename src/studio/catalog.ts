...
export const VIZ_GROUPS: CatalogGroup[] = [
  {
    ...
    items: [
      ...
      { id: "bivariate", label: "Bivariata", desc: "Due variabili insieme", icon: Grid3x3, status: "ready" },
      { id: "dotdensity", label: "Densità di punti", desc: "Un punto per evento", icon: MapPinned, status: "ready" },
      { id: "heatmap", label: "Mappa di calore", desc: "Densità", icon: Flame, status: "ready" },
      { id: "hexbin", label: "Esagoni", desc: "Griglia esagonale", icon: Hexagon, status: "ready" },
      { id: "spike", label: "Spike map", desc: "Picchi per valore", icon: Activity, status: "ready" },
  ...
  },
  {
    ...
    label: "Grafici",
    items: [
      { id: "bar", label: "Barre", desc: "Confronti", icon: BarChart3, status: "ready" },
      { id: "line", label: "Linee", desc: "Andamenti", icon: LineChart, status: "ready" },
      { id: "area", label: "Aree", desc: "Volumi nel tempo", icon: AreaChart, status: "ready" },
      { id: "streamgraph", label: "Streamgraph", desc: "Aree fluide nel tempo", icon: Waves, status: "soon" },
      { id: "scatter", label: "Dispersione", desc: "Correlazioni", icon: ScatterChart, status: "ready" },
      ...
      { id: "table", label: "Tabella", desc: "Dati in tabella", icon: Table2, status: "ready" },
